...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT / 'models/yolov5n_fod.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/fod1.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--name', default='yolov5n_fod', help='save to project/name')
