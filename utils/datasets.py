...
class LoadImages:
    ...
    # while True:
    #     print('detesets start video')
    #     # Read stream `i` frames in daemon thread
    #     n, f, read = 0, self.frames[i], 1  # frame number, frame array, inference every 'read' frame
    #     # print(stream,'stream')
    #     cap.open('rtsp://admin:qaz123..@192.168.0.123/LiveMedia/ch1/Media1/trackID=1')
    #
    #     #cap.open(stream)
    #     time.sleep(10)
    #
    ...
    #             else:
    #                 LOGGER.warning(
    #                     f'WARNING: Video stream unresponsive, please check your IP camera connection.{time.time()}')
